  ...
  User.findOne({'username': username }, 'username password', function (err, user) {
    ...
    if (!user) {
      new User({
        ...
        console.log('new user object before hash', newUser);
        newUser.hashPassword();
        newUser.save(function (err) {
          if(err) console.log('save after hashPassword callback error', err);
          console.log('new user object after hash', newUser);
          res.redirect('/');
        });
      });
    } else {
